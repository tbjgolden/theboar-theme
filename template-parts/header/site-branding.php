<div class="site-branding">
  <a id="boar-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
  ...
  if ( is_front_page() && is_home() ) {
    echo '
    <h1 class="site-title">
      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" style="width:auto;font-size:200%;" fill-rule="nonzero" viewBox="1850 0 6142 1720">
        <g fill="#535353">
