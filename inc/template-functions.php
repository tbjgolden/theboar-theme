...
function twentynineteen_get_the_archive_title() {
  if ( is_category() ) {
    return '<span class="page-description">' . single_term_title( '', false ) . '</span>';
  } elseif ( is_tag() ) {
    return '<span class="page-description">' . single_term_title( '', false ) . '</span>';
  } elseif ( is_author() ) {
    return '<span class="page-description">' . get_the_author_meta( 'display_name' ) . '</span>';
  } elseif ( is_year() ) {
    return '<span class="page-description">' . get_the_date( _x( 'Y', 'yearly archives date format', 'twentynineteen' ) ) . '</span>';
  } elseif ( is_month() ) {
    return '<span class="page-description">' . get_the_date( _x( 'F Y', 'monthly archives date format', 'twentynineteen' ) ) . '</span>';
  } elseif ( is_day() ) {
    return '<span class="page-description">' . get_the_date() . '</span>';
  } elseif ( is_post_type_archive() ) {
    return '<span class="page-description">' . post_type_archive_title( '', false ) . '</span>';
  } elseif ( is_tax() ) {
    $taxonomy = get_taxonomy( get_queried_object()->taxonomy );
    return '<span class="page-description">' . $taxonomy->labels->singular_name . '</span>';
  } else {
    return '';
  }
}
